...
// TODO: more clever logic is needed to decide on the grouping
function _multiColumnBetter(object) {
  ...
  for (const key of keys) {
    ...
    if (keysLength > 60) return false

    valueLength += object[key].toString().length
